...
palm.configure(api_key="AIzaSyDwj5p73l7diKdHC2cLTbv5Haz5KYo4skc")
os.environ["REPLICATE_API_TOKEN"] = "r8_ZI6j8rw4B9mXzOvSt9JRwbgWoXkuowd2ES3sn"
...
def workout_result():
    ...
    q = "workout plan for people with age " + q + " in table form"
